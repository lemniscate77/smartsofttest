...
History - класс для хранения информации о произошедших операциях конвейризации и отправки их в БД.
ConvertToJavaObj - PoJo для получения валют с сайта ЦБРФ
WorkWithBD - класс для работы с БД
Valute - класс для хранения информации о валютах с сайта ЦБРФ
